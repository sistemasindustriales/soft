...
$lang['client_vat_number']                       = 'Número de CUIT';
...
$lang['contract_subject_tooltip'] = 'El sujeto también es visible para el cliente';
...
$lang['newsfeed_unpin_post']                                = 'Desbloquear publicación';
...
$lang['invoice_item_lowercase']            = 'artículos de factura';
...
$lang['invoice_item_add_heading']          = 'Agregar artículo nuevo';
...
$lang['kb_group_add_edit_note']        = 'Nota: todos los artículos de este grupo se ocultarán si se selecciona deshabilitado';
...
$lang['report_leads_sources_conversions']                 = 'Conversión de fuentes';
...
$lang['settings_tickets_max_attachments']                          = 'Entradas máximas para los billetes';
...
$lang['settings_sales_company_info_note']                          = 'Esta información se mostrará en las facturas / presupuestos / pagos y otros documentos PDF donde se requiera la información de la compañía.';
...
$lang['dt_info_empty']        = 'Demostración 0 a 0 de 0 {0}';
$lang['dt_info']              = 'Demostración _START_ a _END_ de _TOTAL_ {0}';
...
$lang['replied_to_ticket_successfully']                      = 'Respondió a la Solicitud #%s exitosamente';
...
$lang['ticket_single_assign_to_me_on_update']                = 'Asignarme esta solicitud automáticamente';
...
$lang['ticket_access_by_department_denied']                  = 'No tienes acceso a este solicitud. Pertenece a un sector al que no está asignado.';
...
$lang['task_follower_removed']              = 'Seguidor de tareas eliminado con éxito';
$lang['task_assignee_removed']              = 'Tarea asignada eliminada con éxito';
...
$lang['clients_contracts_dt_end_date']   = 'Fecha finalización';
...
$lang['clients_single_ticket_information_heading'] = 'información de la solicitud';
...
$lang['clients_ticket_single_add_reply_heading']   = 'Añadir respuesta a esta solicitud';
...
$lang['lead_to_client_base_converted_success'] = 'Lead convertido al cliente con éxito';
...
$lang['settings_sales_next_estimate_number']                        = 'Próximo número de presupuesto';
$lang['settings_sales_next_estimate_number_tooltip']                = 'Establezca este campo en 1 si desea comenzar desde el principio';
$lang['settings_sales_decrement_estimate_number_on_delete']         = 'Número de Presupuesto de decremento en eliminar';
$lang['settings_sales_decrement_estimate_number_on_delete_tooltip'] = '¿Desea disminuir el número de presupuesto cuando se elimina el último presupuesto? Ej. Si se configura esta opción en SÍ y antes de eliminar el presupuesto, el próximo número de presupuesto es 15, el próximo presupuesto se reducirá a 14.Si se establece en NO, el número permanecerá en 15. Si ha configurado la eliminación solo en el último presupuesto a NO, debe establecer esta opción en NO también para mantener el siguiente número de presupuesto no disminuido.';
...
$lang['settings_exclude_estimate_from_client_area_with_draft_status'] = 'Excluir presupuestos con estado de borrador del área de clientes';
...
$lang['estimate_sent_to_client_success']          = 'El presupuesto se envía con éxito al cliente.';
...
$lang['clients_estimate_failed_action']         = 'No se pudo tomar acción en este presupuesto';
...
$lang['amount_display_in_base_currency'] = 'El monto se muestra en su moneda base: solo use este informe si está usando 1 moneda para pagos y gastos.';
# Leads
...
$lang['contract_trash_tooltip']               = 'Si agrega el contrato a la papelera, no se mostrará en el lado del cliente, no se incluirá en el gráfico y otras estadísticas y, de forma predeterminada, no se mostrará cuando se enumeren todos los contratos.';
...
$lang['contract_renewed_successfully']        = 'Contrato renovado con éxito';
...
$lang['no_contract_renewals_history_heading'] = 'Historial de renovación de contratos';
$lang['contract_renewed_by']                  = 'Renovaste este contrato %s ';
$lang['contract_renewal_deleted']             = 'Renovación eliminada exitosamente';
$lang['contract_renewal_delete_fail']         = 'Error al eliminar la renovación del contrato. Contactar administrador';
...
$lang['contract_renewal_old_end_date']        = 'La fecha de finalización del contrato anterior era: %s';
...
$lang['goal_notify_when_fail']                                          = 'Notificar a los miembros del personal cuando el objetivo no se logró';
...
$lang['goal_type_increase_customers_without_leads_conversions']         = 'Aumentar el número de cliente';
$lang['goal_type_increase_customers_without_leads_conversions_subtext'] = 'La conversión de potenciales clientes está excluida';
$lang['goal_type_increase_customers_with_leads_conversions']            = 'Aumentar el número de cliente';
$lang['goal_type_increase_customers_with_leads_conversions_subtext']    = 'Conversiones de potenciales clientes está incluido';
...
$lang['goal_type_total_estimates_converted']                            = 'Conversión X Presupuestos ';
$lang['goal_type_total_estimates_converted_subtext']                    = 'Se tomarán solo los presupuestos que se convertirán a facturas.';
$lang['goal_type_income_subtext']                                       = 'Los ingresos se calcularán en su moneda base (no convertidos)';
...
$lang['expense_recurring_send_custom_on_renew']       = 'Envíe la factura al correo electrónico del cliente cuando se vuelva a crear el gasto.';
...
$lang['numbers_not_formatted_while_editing'] = 'El número en el campo de entrada no tiene formato mientras se edita / agrega un elemento y debe permanecer sin formato. No intente formatearlo manualmente aquí.';
# Contracts
$lang['contracts_view_expired']         = 'Expirada';
$lang['contracts_view_without_dateend'] = 'Contratos sin fecha límite';
...
# Estimates
$lang['show_shipping_on_estimate']         = 'Mostrar detalles de envío en presupuesto';
...
$lang['customer_update_address_info_on_invoices']              = 'Actualice la información de envío / facturación en todas las facturas / presupuestos anteriores';
$lang['customer_update_address_info_on_invoices_help']         = 'Si marca este campo, la información de envío y facturación se actualizará a todas las facturas y Presupuestos. Nota: Las facturas con estado pagado no se verán afectadas.';
...
$lang['task_public_help']          = 'Si configura esta tarea como pública, estará visible para todos los miembros del personal. De lo contrario, solo será visible para los miembros asignados, seguidores, creadores o administradores.';
...
$lang['settings_gcal_main_calendar_id_help']                                 = 'Este es el calendario principal de la empresa. Se mostrarán todos los eventos de este calendario. Si desea especificar un calendario según los sectores, puede agregarlo en el ID de calendario de Google del departamento.';
...
$lang['leads_email_integration_notify_when_lead_contact_more_times'] = 'Notificar si el cliente potencial envía un correos varias veces';
...
$lang['bulk_pdf_exporter']             = 'Exportación masiva de PDF';
...
$lang['utility_db_backup_note']          = 'Nota: Debido al tiempo limitado de ejecución y la memoria disponible para PHP, puede que no sea posible realizar copias de seguridad de bases de datos muy grandes. Si su base de datos es muy grande, es posible que deba realizar una copia de seguridad directamente desde su servidor SQL a través de la línea de comandos, o que su administrador del servidor lo haga por usted si no tiene privilegios de root.';
...
$lang['add_checklist_item']       = 'Elemento de la lista de verificación';
...
$lang['lead_set_reminder_title'] = 'Añadir recordatorio de cliente potencial';
...
$lang['settings_sales_require_client_logged_in_to_view_estimate'] = 'Requiere que el cliente esté conectado para ver el presupuesto';
...
$lang['proposal_allow_comments_help']           = 'Si marca esta opción, se permitirán comentarios cuando su cliente vea la propuesta.';
$lang['proposal_edit']                          = 'Editar';
$lang['proposal_pdf']                           = 'PDF';
$lang['proposal_send_to_email']                 = 'Enviar al email';
$lang['proposal_send_to_email_title']           = 'Enviar propuesta al correo electrónico';
...
$lang['proposal_sent_to_email_fail']            = 'Error al enviar la propuesta al correo electrónico.';
$lang['proposal_copy_fail']                     = 'No se pudo copiar la propuesta';
$lang['proposal_copy_success']                  = 'Propuesta copiada exitosamente';
$lang['proposal_status_changed_success']        = 'El estado de la propuesta cambió con éxito';
...
$lang['proposal_converted_to_estimate_success'] = 'Propuesta convertida para estimar con éxito.';
...
$lang['form_validation_valid_email'] = 'Los {field} El campo debe contener una dirección de email válida.';
...
$lang['not_contract_expiry_reminder']                 = 'Recordatorio de expiración del contrato - %s ...';
...
$lang['not_received_one_or_more_messages_lead']       = 'Recibió un email de cliente potencial';
...
$lang['not_lead_activity_converted_email']                        = 'El correo electrónico principal ha cambiado. El primer correo electrónico principal fue:% sy se agregó como cliente con correo electrónico %s';
...
$lang['not_task_added_you_as_follower']                           = 'te agregó como seguidor en la tarea %s ...';
$lang['not_task_added_someone_as_follower']                       = 'Agregado %s como seguidor en la tarea %s ...';
$lang['not_task_added_himself_as_follower']                       = 'se agregó como seguidor en la tarea %s ...';
$lang['not_task_assigned_to_you']                                 = 'te asignó una tarea %s ...';
$lang['not_task_assigned_someone']                                = 'asignado %s a la tarea %s ...';
$lang['not_task_will_do_user']                                    = 'hará tarea %s ...';
...
$lang['not_estimate_customer_accepted']                           = '¡Felicidades! Presupuesto aceptado por el cliente con número %s';
$lang['not_estimate_customer_declined']                           = 'Cliente rechazó el presupuesto con el número %s';
...
$lang['estimate_activity_number_changed']                         = 'Número de presupuesto desde %s a %s';
$lang['invoice_activity_number_changed']                          = 'Número de factura cambiado de %s a %s';
$lang['invoice_estimate_activity_updated_item_short_description'] = 'artículo actualizado de la descripción corta %s a %s';
$lang['invoice_estimate_activity_updated_item_long_description']  = 'elemento actualizado descripción larga de <b>%s</b> a <b>%s</b>';
$lang['invoice_estimate_activity_updated_item_rate']              = 'tasa de artículo actualizada de %s a %s';
$lang['invoice_estimate_activity_updated_qty_item']               = 'cantidad actualizada en el artículo <b>%s</b> desde %s a %s';
$lang['invoice_estimate_activity_added_item']                     = 'añadido nuevo artículo <b>%s</b>';
$lang['invoice_estimate_activity_sent_to_client']                 = 'Presupuesto enviado al cliente';
$lang['estimate_activity_client_accepted_and_converted']          = 'El cliente aceptó este Presupuesto. El presupuesto se convierte a factura con número. %s';
...
$lang['leads_sort_by_kanban_order'] = 'Orden en línea de tiempo';
...
$lang['home_lead_overview']           = 'Descripción general de clientes potenciales';
$lang['home_my_projects']             = 'Mis proyectos';
$lang['home_announcements']           = 'Anuncios';

# Settings
$lang['settings_leads_kanban_limit']                                    = 'Límite de línea de tiempo por estado';
...
$lang['task_is_billed']         = 'Esta tarea se factura en factura con número. %s';
...
# Invoices
$lang['invoice_task_item_project_tasks_not_included'] = 'Las tareas de proyectos no están incluidas en esta lista.';
...
$lang['timers_started_confirm_logout'] = 'Se iniciaron cronómetros de tareas! <br /> ¿Está seguro de que desea cerrar la sesión sin detener los temporizadores?';
$lang['confirm_logout']                = 'Cerrar sesión';
$lang['timer_top_started']             = 'Empezó a las %s';

# Projects
$lang['cant_change_billing_type_billed_tasks_found']         = 'No puede cambiar el tipo de facturación. Tareas facturadas ya encontradas para este proyecto.';
$lang['project_customer_permission_warning']                 = 'El sistema indicó que el contacto principal no tiene permiso para proyectos. El contacto principal no podrá ver el proyecto. Considere agregar permiso en el perfil de contacto.';
...
$lang['project_mark_all_tasks_as_completed']                 = 'Marque todas las tareas como completadas y detenga todos los temporizadores (no se envían notificaciones a los miembros del proyecto)';
...
$lang['failed_to_add_project_timesheet_end_time_smaller']    = 'Error al agregar la hoja de tiempo. La hora de finalización es más pequeña que la de inicio.';
...
$lang['invoice_project_item_name_data']                      = 'Nombre del árticulo';
...
$lang['invoice_project_timesheet_individually_data']         = 'Hora de inicio de la hoja de tiempo + hora de finalización + tiempo total registrado';
...
$lang['project_setting_view_task_checklist_items']           = 'ver los elementos de la lista de verificación de tareas';
...
$lang['project_activity_marked_all_tasks_as_complete'] = 'Marcó todas las tareas como completas';
...
$lang['tasks_reminder_notification_before']                    = 'Recordatorio de la fecha límite de la tarea antes (días)';
$lang['not_task_deadline_reminder']                            = 'Recordatorio de la fecha límite de la tarea';
...
$lang['invoice_project_see_billed_tasks']                      = 'Ver las tareas que se facturarán.';
$lang['invoice_project_all_billable_tasks_marked_as_finished'] = 'Todas las tareas facturadas se marcarán como finalizadas.';
...
$lang['project_invoice_timers_started']                        = 'Los temporizadores de tareas que se encuentran ejecutándose en tareas facturables, no se pueden crear facturas. Detenga los temporizadores de tareas para crear la factura.';
...
$lang['auto_close_ticket_after']                 = 'Auto cierre de solicitud después (Horas)';
...
$lang['receive_notification_on_new_ticket']      = 'Recibir notificación sobre nueva solicitud abierta.';
$lang['receive_notification_on_new_ticket_help'] = 'Todos los miembros del personal que pertenezcan al sector de las solicitudes recibirán una notificación de que la nueva solicitud está abierto.';
...
$lang['default_leads_kanban_sort']               = 'Predeterminado línea de tiempo';
...
$lang['no_primary_contact']                      = 'Este cliente tiene contacto primario. Debe configurar el inicio de sesión de contacto primario como cliente. Se recomienda a todos los clientes tener contactos primarios.';
$lang['leads_merge_customer']                    = 'Fusión de campos de clientes';
...
# Version 1.1.2
$lang['leads_switch_to_kanban']                   = 'Cambiar a línea de tiempo';
...
$lang['contract_send_to_client_modal_heading']    = 'Enviar contrato al correo electrónico';
...
$lang['contract_sent_to_client_success']          = 'El contrato se envía con éxito al cliente.';
...
# Version 1.1.7
$lang['email_template_ticket_warning']          = 'Si la solicitud se importa con canalización de correo electrónico y el contacto no existe en el CRM, los campos no serán reemplazados.';
...
$lang['changing_items_affect_warning']          = 'Cambiar la información del artículo no afectará las facturas / presupuestos / propuestas creadas.';
...
$lang['proposal_due_after']                     = 'Propuesta Vencida Después (días)';
$lang['project_progress']                       = 'Progreso';
$lang['calculate_progress_through_tasks']       = 'Calcular el progreso a través de las tareas.';
$lang['allow_customer_to_change_ticket_status'] = 'Permitir que el cliente cambie el estado de la solicitud desde el área de clientes';
...
$lang['lead_lock_after_convert_to_customer']    = 'No permitir que se editen los prospectos después de que se conviertan a clientes (no se aplican los administradores)';
...
$lang['not_task_new_comment']         = 'comentó la tarea %s';

# Version 1.1.8
$lang['invoice_number_exists']                  = 'Este número de factura existe para el año en curso.';
$lang['estimate_number_exists']                 = 'Este número de presupuesto existe para el año en curso.';
...
$lang['help_project_permissions']               = 'VIEW le permite al miembro del personal ver TODOS los proyectos. Si solo desea que vean los proyectos que tienen asignados (agregados como miembros), no le dé permisos de VER.';
$lang['help_tasks_permissions']                 = 'VER permite al miembro del personal ver TODAS las tareas. Si solo desea que vean las tareas a las que están asignadas o que siguen, no le dé permisos de VER.';
...
$lang['staff_stats_last_month_total_logged_time'] = 'Último mes registrado tiempo';
...
$lang['upcoming_tasks']                             = 'Próximas tareas';
...
$lang['task_no_checklist_items_found']             = 'Elementos de la lista de verificación no encontrados para esta tarea';
...
$lang['leads_report_converted_notice']                        = 'Solo los clientes potenciales que pertenezcan al estado predeterminado del Cliente se tomarán como clientes potenciales convertidos, si los clientes potenciales pertenecen al estado predeterminado del cliente y no se convierten al cliente todavía se contarán como clientes potenciales convertidos';
...
$lang['proposal_warning_email_change']                      = 'Correo electrónico cambiado para %s. Esta %s esta vinculado a propuesta/s. ¿Quieres actualizar todos los correos electrónicos de propuestas vinculados a %s?';
...
$lang['proposals_emails_updated']                           = 'Todos los correos electrónicos de propuestas vinculados a este %s actualizados a %s';
...
$lang['remove_tax_name_from_item_table_help'] = 'Ej. Artículo IMPUESTO 15 & # 37; se mostrará como 15 & # 37; sin el nombre del impuesto (No se aplica si se encontraron varios impuestos con el mismo nombre y porcentaje de impuesto para el artículo)';
$lang['back_to_project']                      = 'Volver al proyecto';
$lang['view_kanban']                          = 'Ver línea de tiempo';
$lang['invoice_is_overdue']                   = 'Esta factura está vencida por%s días';

# Version 1.2.9
$lang['time_decimal']                            = 'Tiempo (decimal)';
$lang['time_h']                                  = 'Tiempo (horas)';
$lang['proposal_number_prefix']                  = 'Número de propuesta Prefijo';
...
$lang['not_published_new_post']                  = 'Hacer una publicación';
...
$lang['lead_info']                               = 'Información de cliente';
...
$lang['estimate_items']                          = 'Artículos presupuestados';
...
$lang['include_proposal_items_merge_field_help'] = 'Incluya elementos de propuesta con el campo de combinación en cualquier parte del contenido de la propuesta como %s';
...
$lang['proposal_sync_1_info']                    = 'Todos los datos de la propuesta se almacenan por separado para cada propuesta después de la creación. Actualizar la información de %s no afectará las propuestas creadas anteriormente para esto %s.';
...
# Version 1.3.0
$lang['expense_include_additional_data_on_convert'] = 'Incluya detalles adicionales a la descripción larga del artículo tomada de este gasto.';
...
$lang['permission_projects_based_on_assignee']              = 'Si el miembro del personal no tiene permiso, VER (Global) se mostrará solo en los proyectos donde el miembro del personal se agregue como miembro del proyecto.';
$lang['permission_tasks_based_on_assignee']                 = 'Si el miembro del personal no tiene permiso, VER (Global) mostrará solo las tareas donde el miembro del personal es seguidor, asignado, la tarea es pública o en Configuración-> Configuración-> Tareas-> Permitir que todo el personal vea todas las tareas relacionadas con los proyectos. a SÍ cuando la tarea está vinculada al proyecto.';
...
$lang['company_vat_number']                                 = 'Número de valor agregado';
...
$lang['invoice_activity_auto_converted_from_estimate']      = 'Factura auto creada a partir de presupuesto con número. %s';
...
# Version 1.5.1
$lang['ticket_linked_to_project']                                = 'Esta solicitud está vinculado al proyecto: %s';
...
$lang['estimate_due_after']                                      = 'Presupuesto Vencido Después (días)';
...
$lang['recurring_recreate_hour_notice']           = '%s se recreará en una hora específica del día según la configuración ubicada en Configuración-> Configuración-Tarea sistemas';
...
$lang['new_task_auto_assign_current_member']      = 'Asignar automáticamente creador de tareas cuando se crea una nueva tarea';
...
$lang['not_customer_viewed_proposal']                        = 'Una propuesta con número %s ha sido visto';
...
$lang['task_is_overdue']                                     = 'Esta tarea está atrasada';
...
$lang['allow_staff_view_proposals_assigned']                 = 'Permitir que los miembros del personal vean las propuestas donde están asignados';
...
$lang['enable_two_factor_authentication']              = 'Habilitar la autenticación de dos factores';
$lang['two_factor_authentication_info']                = 'La autenticación de dos factores se proporciona por correo electrónico. Antes de habilitar la autenticación de dos factores, asegúrese de que la configuración de SMTP esté correctamente configurada y que el sistema pueda enviar un correo electrónico. La clave de autenticación única se enviará al correo electrónico al iniciar sesión.';
...
$lang['project_marked_as_finished_to_contacts']        = 'Enviar <b>Proyecto marcado como terminado</b> correo electrónico a los contactos de los clientes';
...
$lang['timer_started_change_status_in_progress'] = 'Cambie el estado de la tarea a En progreso al iniciarse el temporizador (válido solo si el estado de la tarea no está iniciado)';
...
$lang['ticket_add_response_and_back_to_list'] = 'Volver a la lista de solicitudes después de enviar la respuesta';
...
$lang['hide_tasks_on_main_tasks_table']                    = 'Ocultar tareas de proyecto en la tabla de tareas principales (área de administración)';
$lang['ticket_replies_order']                              = 'Orden de las respuestas de la solicitud';
$lang['ticket_replies_order_notice']                       = 'El mensaje inicial de la solicitud siempre se mostrará como primero.';
...
$lang['credit_note_sent_to_client_success']                      = 'La nota de crédito se envio al cliente.';
...
$lang['zip_credit_notes']                                        = 'Notas de crédito Zip';
$lang['statement_credit_note_details']                           = 'Nota de crédito %s';
$lang['statement_credits_applied_details']                       = 'Créditos aplicados de la nota de crédito %s - %s para pago of %s';
...
$lang['show_project_on_credit_note']              = 'Mostrar el nombre del proyecto en nota de crédito';
...
$lang['showing_search_result']                                  = 'Mostrando resultados de búsqueda de: %s';
...
$lang['allow_staff_view_estimates_assigned']                    = 'Permitir que los miembros del personal vean los presupuestos donde están asignados';
...
$lang['request_data_removal']                                   = 'Solicitud de eliminación de datos';
...
$lang['not_new_ticket_reply']                           = 'El cliente respondió a la solicitud - %s';
$lang['receive_notification_on_new_ticket_replies']     = 'Recibir notificación cuando el cliente responda a una solicitud.';
$lang['receive_notification_on_new_ticket_reply_help']  = 'Todos los miembros del personal que pertenecen al sector de solicitudes recibirán una notificación cuando el cliente responda a una solicitud.';
