                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="tags" class="control-label"> <p style="font-size:14px;" class="req text-danger"><i class="fa fa-exclamation" aria-hidden="true"></i> <b>Seleccionar etiqueta OP:</b></p></label>
