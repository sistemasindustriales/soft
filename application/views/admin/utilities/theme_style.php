            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                     <a href="#" onclick="save_theme_style(); return false;" class="btn btn-info">Guardar</a>
                 </div>
             </div>
         </div>
                ...
                <div class="modal-content theme_style_modal_example">
                  <div class="modal">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Ejemplo de encabezado</h4>
                        <span class="color-white">Texto de ejemplo</span>
                    </div>
