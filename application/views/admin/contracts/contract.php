                  ...
                  <div class="horizontal-scrollable-tabs preview-tabs-top">
                     ...
                     <div class="horizontal-tabs">
                        <ul class="nav nav-tabs tabs-in-body-no-margin contract-tab nav-tabs-horizontal mbot15" role="tablist">
                           ...
                           <li role="presentation" class="<?php if($this->input->get('tab') == 'tab_comments'){echo 'active';} ?>">
...
<hr>
                              ...
                              <textarea name="content" id="comment" rows="12" class="form-control mtop15 contract-comment">
COMPRA: 
