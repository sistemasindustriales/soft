   ...
   <nav>
      ...
      <ul class="nav navbar-nav navbar-right">
         ...
         <li class="icon header-newsfeed">
            <a href="#" class="open_newsfeed" data-toggle="tooltip" title="<?php echo _l('whats_on_your_mind'); ?>" data-placement="bottom"><i class="fa fa-warning fa-fw fa-lg" aria-hidden="true"></i></a>
         </li>
         <?php } ?>
