...
<head>
    ...
    <link href="https://softindustrials1.000webhostapp.com/assets/css/reset.min.css?v=2.1.0" rel="stylesheet">
  <link href='http://fonts.googleapis.com/css?family=Roboto' rel='stylesheet' type='text/css'>
<link href="<?php echo base_url('assets/plugins/app-build/vendor.css?v='.get_app_version()); ?>" rel="stylesheet">
    <?php if($isRTL === 'true'){ ?>
    <link href="https://softindustrials1.000webhostapp.com/assets/plugins/bootstrap-arabic/css/bootstrap-arabic.min.css" rel="stylesheet">
    <?php } ?>
    <?php if(isset($calendar_assets)){ ?>
    <link href='https://softindustrials1.000webhostapp.com/assets/plugins/fullcalendar/fullcalendar.min.css?v=2.1.0' rel='stylesheet' />
    <?php } ?>
