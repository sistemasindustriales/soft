...
<li role="presentation" class="tab-separator toggle_view">
         ...
         <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="tab_reminders">
               <a href="#" class="btn btn-info btn-xs" data-toggle="modal" data-target=".reminder-modal-credit_note-<?php echo $credit_note->id; ?>"> <?php echo _l('credit_note_set_reminder_title'); ?></a>
               <hr />
