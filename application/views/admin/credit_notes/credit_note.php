...
<div id="wrapper">
 ...
 <div class="row">
   <div style="margin-top:10px;" class="col-md-3">
    ...
    <a href="#" class="btn btn-default" data-toggle="modal" data-target="#billing_and_shipping_details"><i class="fa fa-pencil-square-o"></i> Proveedor</a>
...
<?php echo render_input('reference_no','Nombre del Proveedor (.PDF)',$value); ?>
<?php $value = (isset($credit_note) ? $credit_note->adminnote : ''); ?>
<?php echo render_textarea('adminnote','Nota (privada)',$value); ?>
