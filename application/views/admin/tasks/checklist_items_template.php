...
<div class="checklist relative<?php if($list['finished'] == 1 && $list['finished_from'] != get_staff_user_id()){echo ' mbot25';} ?>" data-checklist-id="<?php echo $list['id']; ?>">
    ...
    <p class="small mtop10 checklist-item-completed-by"><?php echo _l('task_checklist_item_completed_by',get_staff_full_name($list['finished_from'])); ?></p>
    <?php } ?>
</div>
