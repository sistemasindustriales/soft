...
<hr />
<?php if ($error == true){
	echo '<div class="text-center alert alert-danger">Debe corregir los requisitos para continuar la instalación</div>';
} else {
	echo '<div class="text-center">';
	echo '<form action="" method="post" accept-charset="utf-8">';
	echo '<input type="hidden" value="true" name="requirements_success">';
	echo '<div class="text-left">';
	echo '<button type="submit" class="btn btn-success">Ir a los permisos de archivos / carpetas</button>';
	echo '</div>';
	echo '</form>';
	echo '</div>';
}
